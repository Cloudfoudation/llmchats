...
import { Group, UpdateGroupRequest } from '@/types/groups';
...
export function EditGroupModal({ isOpen, onClose, group, onGroupUpdated }: EditGroupModalProps) {
    const { updateGroup, isUpdating, error } = useGroups();
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const success = await updateGroup(group.groupId, formData);
        if (success) {
            onGroupUpdated();
        }
    };
        ...
        <div className="fixed inset-0 bg-black/50 dark:bg-black/70 flex items-center justify-center z-50 p-4">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl dark:shadow-2xl w-full max-w-md 
                ...
                <div className="flex justify-between items-center p-6 border-b border-gray-200 dark:border-gray-700">
                    <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Edit Group</h2>
                    <button
                        onClick={handleClose}
                        disabled={isUpdating}
                ...
                <form onSubmit={handleSubmit} className="p-6">
                    ...
                    <div className="flex justify-end space-x-3 mt-6">
                        ...
                        <button
                            type="submit"
                            disabled={isUpdating || !formData.groupName?.trim()}
                            className="px-4 py-2 text-sm font-medium text-white bg-blue-600 dark:bg-blue-500 
                                     border border-transparent rounded-md hover:bg-blue-700 dark:hover:bg-blue-600 
